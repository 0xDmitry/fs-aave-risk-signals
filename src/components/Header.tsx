  ...
  return (
    <header className="bg-paper/80 sticky top-0 z-50 border-b border-line/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          <span className="grid size-10 place-items-center rounded-xl bg-[linear-gradient(248.86deg,#B6509E_10.51%,#2EBAC6_93.41%)] text-sm font-bold tracking-tight text-white shadow-sm ring-1 ring-white/20">
            ARS
          </span>
