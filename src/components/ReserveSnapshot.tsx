    ...
    <section className="rounded-lg border border-line bg-white p-5">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-3">
        <div>
          ...
          <p className="mt-1 text-xl font-semibold text-ink">{reserve.symbol}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500">Network</p>
          <p className="mt-1 text-xl font-semibold text-ink">{reserve.network}</p>
        </div>
        <div>
          <p className="text-xs text-slate-500">{reserve.currentMetricLabel}</p>
          <p className="mt-1 text-xl font-semibold text-ink">{reserve.currentMetricValue}</p>
        </div>
      </div>
